            ...
            <footer className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    ...
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                            ...
                            <span className="text-2xl font-bold text-indigo-600">PropertyX</span>
                        </a>
                        <p className="mt-2 text-sm text-gray-500">Your gateway to finding the perfect property. We specialize in high-quality listings and exceptional service.</p>
                    </div>
                    ...
                    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li><a className="text-gray-600 hover:text-gray-800">Property Listings</a></li>
                                <li><a className="text-gray-600 hover:text-gray-800">Buyers Guide</a></li>
                                <li><a className="text-gray-600 hover:text-gray-800">Sellers Guide</a></li>
                                <li><a className="text-gray-600 hover:text-gray-800">Mortgage Calculator</a></li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                ...
                                <li><a className="text-gray-600 hover:text-gray-800">Property Valuation</a></li>
                                <li><a className="text-gray-600 hover:text-gray-800">Market Insights</a></li>
                                <li><a className="text-gray-600 hover:text-gray-800">Testimonials</a></li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                ...
                                <li><a className="text-gray-600 hover:text-gray-800">LinkedIn</a></li>
                            </nav>
                        </div>
                    </div>
                </div>
                <div className="bg-gray-100">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 PropertyX <a href="https://twitter.com/dreamhomes" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@PropertyX</a></p>
